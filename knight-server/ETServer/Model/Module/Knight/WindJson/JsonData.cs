...
namespace Knight.Core.WindJson
{
    public class JsonNode
    {
        ...
        public int CastInt(string value)
        {
            ...
            Console.WriteLine(string.Format("Value: {0} is not int type.", value));
            return re;
        }
    ...
    public class JsonArray : JsonNode, IEnumerable
    {
        ...
        public override JsonNode this[int nIndex]
        {
            get
            {
                ...
                Console.WriteLine(string.Format("Index out of size limit, Index = {0}, Count = {1}", nIndex, Count));
                return null;
            }
            set
            {
    ...
    public class JsonClass : JsonNode, IEnumerable
    {
        ...
        public override void Add(string rKey, JsonNode rItem)
        {
            ...
            {
                Console.WriteLine("JsonClass dict cannot Add empty string key.");
            }
        }
