...
namespace ETHotfix
{
	...
	[ProtoContract]
	public partial class C2M_TestActorRequest: SerializerBinary, IActorRequest
	{
		[ProtoMember(90, IsRequired = true)]
		public int RpcId { get; set; }
	...
	[ProtoContract]
	public partial class M2C_TestActorResponse: SerializerBinary, IActorResponse
	{
		[ProtoMember(90, IsRequired = true)]
		public int RpcId { get; set; }
	...
	[ProtoContract]
	public partial class PlayerInfo: SerializerBinary, IMessage
	{
	}

	[Message(HotfixOpcode.C2G_PlayerInfo)]
	[ProtoContract]
	public partial class C2G_PlayerInfo: SerializerBinary, IRequest
	{
		[ProtoMember(90, IsRequired = true)]
		public int RpcId { get; set; }
	...
	[ProtoContract]
	public partial class G2C_PlayerInfo: SerializerBinary, IResponse
	{
		[ProtoMember(90, IsRequired = true)]
		public int RpcId { get; set; }
