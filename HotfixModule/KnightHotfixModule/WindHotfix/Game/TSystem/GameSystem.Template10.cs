...
{
    public class TGameSystem<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> : GameSystem
        ...
        where T9 : GameComponent
        where T10 : GameComponent
    {
        public override void Start()
        {
            ...
            ECSManager.Instance.ForeachEntities(this.mResultComps, (rComps) =>
            {
                this.OnStart(this.mResultComps.Get<T1>(), this.mResultComps.Get<T2>(), this.mResultComps.Get<T3>(), this.mResultComps.Get<T4>(),
                             ...
                             this.mResultComps.Get<T9>(), this.mResultComps.Get<T10>());
        ...
        protected virtual void OnStart(T1 rComp1, T2 rComp2, T3 rComp3, T4 rComp4, T5 rComp5, T6 rComp6, T7 rComp7, T8 rComp8, T9 rComp9, T10 rComp10)
        {
        }

        protected virtual void OnUpdate(T1 rComp1, T2 rComp2, T3 rComp3, T4 rComp4, T5 rComp5, T6 rComp6, T7 rComp7, T8 rComp8, T9 rComp9, T10 rComp10)
        {
        }

        protected virtual void OnStop(T1 rComp1, T2 rComp2, T3 rComp3, T4 rComp4, T5 rComp5, T6 rComp6, T7 rComp7, T8 rComp8, T9 rComp9, T10 rComp10)
        {
        }
    }
}