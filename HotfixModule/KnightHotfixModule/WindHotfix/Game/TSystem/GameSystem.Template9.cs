...
{
    public class TGameSystem<T1, T2, T3, T4, T5, T6, T7, T8, T9> : GameSystem
        ...
        where T9 : GameComponent
    {
        ...
        protected virtual void OnStart(T1 rComp1, T2 rComp2, T3 rComp3, T4 rComp4, T5 rComp5, T6 rComp6, T7 rComp7, T8 rComp8, T9 rComp9)
        {
        }

        protected virtual void OnUpdate(T1 rComp1, T2 rComp2, T3 rComp3, T4 rComp4, T5 rComp5, T6 rComp6, T7 rComp7, T8 rComp8, T9 rComp9)
        {
        }

        protected virtual void OnStop(T1 rComp1, T2 rComp2, T3 rComp3, T4 rComp4, T5 rComp5, T6 rComp6, T7 rComp7, T8 rComp8, T9 rComp9)
        {
        }
    }
}