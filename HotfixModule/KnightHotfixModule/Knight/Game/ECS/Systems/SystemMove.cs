...
namespace Game.Knight
{
    ...
    ///     CompMove和Collider组件
    /// </summary>
    public class SystemMove : TGameSystem<ComponentMove, ComponentCollider, ComponentTransform>
    {
        protected override void OnUpdate(ComponentMove rCompMove, ComponentCollider rCompCollider, ComponentTransform rCompTrans)
        {
            ...
            // 和墙体的碰撞检测
            Move_RayForword(rCompCollider, rCompMove, rCompTrans);

            // 设置位置
            rCompTrans.Position += rCompMove.MoveSpeed * rCompMove.SpeedRate * 0.075f;
            // 设置位置的高度
        ...
        {
            RaycastHit rHitInfo;
            Vector3 rActorPos = rCompTrans.Position + Vector3.up * 1.0f;
#if UNITY_EDITOR
        ...
        private void Move_RayForword(ComponentCollider rCompCollider, ComponentMove rCompMove, ComponentTransform rCompTrans)
        {
            RaycastHit rHitInfo;
