...
{
    unsafe class Knight_Core_IndexedDict_2_String_ILTypeInstance_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Knight.Core.IndexedDict<System.String, ILRuntime.Runtime.Intepreter.ILTypeInstance>);
            args = new Type[]{};
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new Knight.Core.IndexedDict<System.String, ILRuntime.Runtime.Intepreter.ILTypeInstance>();
