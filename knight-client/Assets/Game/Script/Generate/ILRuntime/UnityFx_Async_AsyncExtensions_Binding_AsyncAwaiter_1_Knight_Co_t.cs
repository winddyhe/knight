...
{
    unsafe class UnityFx_Async_AsyncExtensions_Binding_AsyncAwaiter_1_Knight_Core_WaitAsync_Binding_WaitForSecondsRequest_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(UnityFx.Async.AsyncExtensions.AsyncAwaiter<Knight.Core.WaitAsync.WaitForSecondsRequest>);
            args = new Type[]{};
            ...
            app.RegisterCLRCreateDefaultInstance(type, () => new UnityFx.Async.AsyncExtensions.AsyncAwaiter<Knight.Core.WaitAsync.WaitForSecondsRequest>());


        }

        static void WriteBackInstance(ILRuntime.Runtime.Enviorment.AppDomain __domain, StackObject* ptr_of_this_method, IList<object> __mStack, ref UnityFx.Async.AsyncExtensions.AsyncAwaiter<Knight.Core.WaitAsync.WaitForSecondsRequest> instance_of_this_method)
        {
