...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityFx_Async_AsyncExtensions_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            args = new Type[]{typeof(Knight.Framework.AssetBundles.ABLoader.LoaderRequest)};
        ...
        static StackObject* GetAwaiter_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityFx.Async.IAsyncOperation<Knight.Framework.AssetBundles.ABLoader.LoaderRequest> @op = (UnityFx.Async.IAsyncOperation<Knight.Framework.AssetBundles.ABLoader.LoaderRequest>)typeof(UnityFx.Async.IAsyncOperation<Knight.Framework.AssetBundles.ABLoader.LoaderRequest>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);


            var result_of_this_method = UnityFx.Async.AsyncExtensions.GetAwaiter<Knight.Framework.AssetBundles.ABLoader.LoaderRequest>(@op);
