...
{
    unsafe class Knight_Core_ICustomAttributeProviderExpand_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Knight.Core.ICustomAttributeProviderExpand);
            args = new Type[]{typeof(System.Reflection.ICustomAttributeProvider), typeof(System.Type), typeof(System.Boolean)};
            method = type.GetMethod("IsApplyAttr", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, IsApplyAttr_0);
        ...
        static StackObject* IsApplyAttr_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = Knight.Core.ICustomAttributeProviderExpand.IsApplyAttr(@rProvider, @rType, @bInherit);
