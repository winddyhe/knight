...
{
    unsafe class UnityFx_Async_CompilerServices_AsyncAwaiter_1_AssetLoaderRequest_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(UnityFx.Async.CompilerServices.AsyncAwaiter<Knight.Core.AssetLoaderRequest>);
            args = new Type[]{};
            ...
            app.RegisterCLRCreateDefaultInstance(type, () => new UnityFx.Async.CompilerServices.AsyncAwaiter<Knight.Core.AssetLoaderRequest>());


        }

        static void WriteBackInstance(ILRuntime.Runtime.Enviorment.AppDomain __domain, StackObject* ptr_of_this_method, IList<object> __mStack, ref UnityFx.Async.CompilerServices.AsyncAwaiter<Knight.Core.AssetLoaderRequest> instance_of_this_method)
        {
        ...
        static StackObject* get_IsCompleted_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.GetObjectAndResolveReference(ptr_of_this_method);
            UnityFx.Async.CompilerServices.AsyncAwaiter<Knight.Core.AssetLoaderRequest> instance_of_this_method = (UnityFx.Async.CompilerServices.AsyncAwaiter<Knight.Core.AssetLoaderRequest>)typeof(UnityFx.Async.CompilerServices.AsyncAwaiter<Knight.Core.AssetLoaderRequest>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
