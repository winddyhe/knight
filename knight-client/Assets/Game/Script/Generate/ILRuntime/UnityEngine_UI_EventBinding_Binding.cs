...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_UI_EventBinding_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            args = new Type[]{typeof(System.Action<Knight.Core.EventArg>)};
        ...
        static StackObject* InitEventWatcher_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Action<Knight.Core.EventArg> @rAction = (System.Action<Knight.Core.EventArg>)typeof(System.Action<Knight.Core.EventArg>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
