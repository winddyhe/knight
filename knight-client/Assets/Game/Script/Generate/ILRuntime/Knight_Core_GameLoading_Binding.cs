...
{
    unsafe class Knight_Core_GameLoading_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Knight.Core.GameLoading);
            args = new Type[]{};
        ...
        static StackObject* get_Instance_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = Knight.Core.GameLoading.Instance;
        ...
        static StackObject* Hide_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Knight.Core.GameLoading instance_of_this_method = (Knight.Core.GameLoading)typeof(Knight.Core.GameLoading).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
