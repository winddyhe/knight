...
{
    unsafe class System_Threading_Tasks_Task_1_UnityEngine_UI_UIAssetLoader_Binding_LoaderRequest_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Threading.Tasks.Task<UnityEngine.UI.UIAssetLoader.LoaderRequest>);
            args = new Type[]{};
        ...
        static StackObject* GetAwaiter_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Threading.Tasks.Task<UnityEngine.UI.UIAssetLoader.LoaderRequest> instance_of_this_method = (System.Threading.Tasks.Task<UnityEngine.UI.UIAssetLoader.LoaderRequest>)typeof(System.Threading.Tasks.Task<UnityEngine.UI.UIAssetLoader.LoaderRequest>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
