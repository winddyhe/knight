...
{
    unsafe class UnityFx_Async_CompilerServices_AsyncAwaiter_1_Knight_Core_WaitAsync_Binding_WaitForEndOfFrameRequest_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(UnityFx.Async.CompilerServices.AsyncAwaiter<Knight.Core.WaitAsync.WaitForEndOfFrameRequest>);
            args = new Type[]{};
            ...
            app.RegisterCLRCreateDefaultInstance(type, () => new UnityFx.Async.CompilerServices.AsyncAwaiter<Knight.Core.WaitAsync.WaitForEndOfFrameRequest>());


        }

        static void WriteBackInstance(ILRuntime.Runtime.Enviorment.AppDomain __domain, StackObject* ptr_of_this_method, IList<object> __mStack, ref UnityFx.Async.CompilerServices.AsyncAwaiter<Knight.Core.WaitAsync.WaitForEndOfFrameRequest> instance_of_this_method)
        {
