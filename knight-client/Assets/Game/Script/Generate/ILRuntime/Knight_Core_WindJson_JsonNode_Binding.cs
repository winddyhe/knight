...
{
    unsafe class Knight_Core_WindJson_JsonNode_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Knight.Core.WindJson.JsonNode);
            args = new Type[]{typeof(System.Type)};
            method = type.GetMethod("ToObject", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, ToObject_0);
            args = new Type[]{typeof(Knight.Core.WindJson.JsonNode)};
            method = type.GetMethod("Add", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, Add_1);
            args = new Type[]{typeof(System.String), typeof(Knight.Core.WindJson.JsonNode)};
            method = type.GetMethod("Add", flag, null, args, null);
        ...
        static StackObject* ToObject_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Knight.Core.WindJson.JsonNode instance_of_this_method = (Knight.Core.WindJson.JsonNode)typeof(Knight.Core.WindJson.JsonNode).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* Add_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            Knight.Core.WindJson.JsonNode @rItem = (Knight.Core.WindJson.JsonNode)typeof(Knight.Core.WindJson.JsonNode).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
