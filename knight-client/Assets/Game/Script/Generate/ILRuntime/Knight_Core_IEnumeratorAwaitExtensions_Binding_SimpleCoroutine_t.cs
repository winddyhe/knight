...
{
    unsafe class Knight_Core_IEnumeratorAwaitExtensions_Binding_SimpleCoroutineAwaiter_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Knight.Core.IEnumeratorAwaitExtensions.SimpleCoroutineAwaiter);
            args = new Type[]{};
        ...
        static StackObject* get_IsCompleted_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Knight.Core.IEnumeratorAwaitExtensions.SimpleCoroutineAwaiter instance_of_this_method = (Knight.Core.IEnumeratorAwaitExtensions.SimpleCoroutineAwaiter)typeof(Knight.Core.IEnumeratorAwaitExtensions.SimpleCoroutineAwaiter).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
