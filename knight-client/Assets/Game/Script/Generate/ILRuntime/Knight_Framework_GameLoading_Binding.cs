...
{
    unsafe class Knight_Framework_GameLoading_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Knight.Framework.GameLoading);
            args = new Type[]{};
        ...
        static StackObject* get_Instance_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = Knight.Framework.GameLoading.Instance;
