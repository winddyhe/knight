...
{
    unsafe class Knight_Framework_Net_Packet_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Knight.Framework.Net.Packet);
            args = new Type[]{};
        ...
        static StackObject* get_Opcode_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Knight.Framework.Net.Packet instance_of_this_method = (Knight.Framework.Net.Packet)typeof(Knight.Framework.Net.Packet).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
