...
{
    unsafe class Knight_Framework_EventArg_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            MethodBase method;
            Type[] args;
            Type type = typeof(Knight.Framework.EventArg);
        ...
        static StackObject* Get_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Knight.Framework.EventArg instance_of_this_method = (Knight.Framework.EventArg)typeof(Knight.Framework.EventArg).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
