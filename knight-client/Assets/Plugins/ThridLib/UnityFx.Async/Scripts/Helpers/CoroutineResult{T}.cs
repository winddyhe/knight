...
namespace UnityFx.Async.Helpers
{
	...
	internal class CoroutineResult<T> : AsyncCompletionSource<T>
	{
		#region data
		...
		public CoroutineResult(MonoBehaviour monoBehaviour, Func<IAsyncCompletionSource<T>, IEnumerator> coroutineFunc, object userState)
