...
{
    unsafe class Knight_Core_IEnumeratorAwaitExtensions_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Knight.Core.IEnumeratorAwaitExtensions);
        ...
        static StackObject* GetAwaiter_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = Knight.Core.IEnumeratorAwaitExtensions.GetAwaiter(@instruction);
