...
//ScriptMD5:011E2F021030DC734A8CD9D447BB5152
...
namespace Game
{
	public partial class Sample2Config : ISerializerBinary
	{
		public void Serialize(BinaryWriter rWriter)
		{
			...
			rWriter.Serialize(this.Test51_Lan);
		...
		public void Deserialize(BinaryReader rReader)
		{
			...
			this.Test51_Lan = rReader.Deserialize(this.Test51_Lan);
...
namespace Game
{
	...
	{
		public static Game.Sample2Config Deserialize(BinaryReader rReader, Game.Sample2Config value)
		{
			var bValid = rReader.Deserialize(default(bool));
			if (!bValid) return null;

			var rResult = new Game.Sample2Config();
