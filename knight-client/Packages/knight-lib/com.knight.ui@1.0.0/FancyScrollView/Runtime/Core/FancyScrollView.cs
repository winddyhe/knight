...
namespace FancyScrollView
{
    ...
    public abstract class FancyScrollView<TItemData, TContext> : MonoBehaviour where TContext : class, new()
    {
        ...
        /// セルのコンテキストクラス.
        /// </summary>
        protected virtual List<FancyCell<TItemData, TContext>> PreCreateCells { get; }
        ...
        void ResizePool(float firstPosition)
        {
            ...
            {
                FancyCell<TItemData, TContext> cell = null;
                if (this.PreCreateCells != null && this.PreCreateCells.Count > 0)
                {
                    cell = this.PreCreateCells[this.PreCreateCells.Count - 1];
                    this.PreCreateCells.RemoveAt(this.PreCreateCells.Count - 1);
