...
{
    unsafe class Core_IEnumeratorAwaitExtensions_Binding_SimpleCoroutineAwaiter_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(Core.IEnumeratorAwaitExtensions.SimpleCoroutineAwaiter);
            args = new Type[]{};
        ...
        static StackObject* get_IsCompleted_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Core.IEnumeratorAwaitExtensions.SimpleCoroutineAwaiter instance_of_this_method;
            instance_of_this_method = (Core.IEnumeratorAwaitExtensions.SimpleCoroutineAwaiter)typeof(Core.IEnumeratorAwaitExtensions.SimpleCoroutineAwaiter).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
