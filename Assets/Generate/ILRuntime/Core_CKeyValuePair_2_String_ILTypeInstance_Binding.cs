...
{
    unsafe class Core_CKeyValuePair_2_String_ILTypeInstance_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(Core.CKeyValuePair<System.String, ILRuntime.Runtime.Intepreter.ILTypeInstance>);
            args = new Type[]{};
        ...
        static StackObject* get_Key_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Core.CKeyValuePair<System.String, ILRuntime.Runtime.Intepreter.ILTypeInstance> instance_of_this_method;
            instance_of_this_method = (Core.CKeyValuePair<System.String, ILRuntime.Runtime.Intepreter.ILTypeInstance>)typeof(Core.CKeyValuePair<System.String, ILRuntime.Runtime.Intepreter.ILTypeInstance>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
