...
{
    unsafe class Framework_WindUI_UIRoot_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(Framework.WindUI.UIRoot);
            args = new Type[]{};
        ...
        static StackObject* get_Instance_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = Framework.WindUI.UIRoot.Instance;
        ...
        static object get_DynamicRoot_0(ref object o)
        {
            return ((Framework.WindUI.UIRoot)o).DynamicRoot;
        }
        static void set_DynamicRoot_0(ref object o, object v)
        {
            ((Framework.WindUI.UIRoot)o).DynamicRoot = (UnityEngine.GameObject)v;
        }
