...
{
    unsafe class Model_ASession_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(Model.ASession);
            args = new Type[]{};
        ...
        static StackObject* get_Id_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Model.ASession instance_of_this_method;
            instance_of_this_method = (Model.ASession)typeof(Model.ASession).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
