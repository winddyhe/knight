...
{
    unsafe class Core_Dict_2_String_ILTypeInstance_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(Core.Dict<System.String, ILRuntime.Runtime.Intepreter.ILTypeInstance>);
        ...
        static StackObject* Add_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Core.Dict<System.String, ILRuntime.Runtime.Intepreter.ILTypeInstance> instance_of_this_method;
            instance_of_this_method = (Core.Dict<System.String, ILRuntime.Runtime.Intepreter.ILTypeInstance>)typeof(Core.Dict<System.String, ILRuntime.Runtime.Intepreter.ILTypeInstance>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new Core.Dict<System.String, ILRuntime.Runtime.Intepreter.ILTypeInstance>();
