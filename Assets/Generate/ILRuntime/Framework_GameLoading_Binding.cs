...
namespace ILRuntime.Runtime.Generated
{
    unsafe class Framework_GameLoading_Binding
    {
        ...
        static StackObject* Hide_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Framework.GameLoading instance_of_this_method = (Framework.GameLoading)typeof(Framework.GameLoading).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
